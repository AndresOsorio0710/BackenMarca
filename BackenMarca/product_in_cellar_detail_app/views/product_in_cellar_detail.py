...
from BackenMarca.product_in_cellar_detail_app.models import ProductInCellarDetail
from BackenMarca.product_in_cellar_detail_app.serializers import ProductInCellarDetailSerializer, \
    SaveSerializer, ListSerializer, PICListSerializer, PICSizeListSerializer
...
class ProductInCellarDetailViewSet(
    ...
    def get_serializer_class(self):
        serializer = {
            ...
            'list': ListSerializer,
            'get_pic': ListSerializer,
            'get_pic_all': PICListSerializer,
            'get_pic_size': PICSizeListSerializer,
        }
