...
from BackenMarca.product_sale_app.models import ProductSale
from BackenMarca.product_sale_app.serializers import SaveProductSaleSerializer, ProductSaleListSerializer, ProductSaleSerializer
